...
* XX : 3D tissue reconstruction using spatial transcriptomics data in mouse brain
* XX : 3D tissue reconstruction using spatiall proteomics data in human breast cancer
