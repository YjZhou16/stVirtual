...
Download instructions and the official upstream source are listed in [Data Availability](../../docs/Data-Availability.md#luad).

LUAD uses the shared time-free 2D Stage-1 model and its own lineage-aware 2D Stage-2 RL checkpoint. The audited historical source is recorded in notebook metadata and is not a runtime path.
