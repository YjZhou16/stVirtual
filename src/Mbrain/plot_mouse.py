...
def plot_allframes_policy(
    ...
    sample_key="sample", ann_key="His_anno",
    x_key="cx_aligned", y_key="cy_aligned",
    n_show=20000, s=5, alpha=0.85, seed=0,
    show_birth=False, birth_scale=6.0,
    birth_edgecolor="r", birth_lw=0.6,
    birth_facecolors="none", layout="vertical",  # "vertical": time on rows (old style). "horizontal": time on cols.
    save_path=None, transparent=False,
):
    def _pick(n, k, sd):
        n = int(n)
